...
$consulta = trim($_POST["nome_medico"] ?? "");

if ($consulta === "") {
    echo "<script>
        alert('Campo de busca vazio. Por favor, insira o nome do médico.');
        window.location.href = 'consultar medicos.html';
    </script>";
    exit;
}

// Busca pelo nome do médico
$sql = "SELECT * FROM medico WHERE nome_medico LIKE ?";
        ...
        echo "<tr>
                ...
                <td>
                    <form method='post' action='edição.php' style='display:inline;'>
                        <input type='hidden' name='id_medico' value='" . htmlspecialchars($linha["id_medico"]) . "'>
